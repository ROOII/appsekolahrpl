...
<body>
    ...
    <form action="?hal=edit" method="post">
        ...
        <input type="hidden" name="id" value="<?=$baris['id']?>">
                <tr>
                    <td>NIS</td>
                    <td><input type="text" name="nis" placeholder="Nomor Induk Siswa" value="<?=$baris['nis']?>"></td>
                </tr>
                <tr>
                    <td>NISN</td>
                    <td><input type="text" name="nisn" placeholder="Nomor Induk Siswa Nasional" value="<?=$baris['nisn']?>"></td>
                </tr>
                <tr>
                    <td>Nama Siswa</td>
                    <td><input type="text" name="nama" placeholder="Nama Siswa" value="<?=$baris['nama_siswa']?>"></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                ...
                <tr>
                    <td>HP</td>
                    <td><input type="text" name="hp" placeholder="Nomor Hp" value="<?=$baris['hp']?>"></td>
                </tr>
                <tr>
                    <td>Agama</td>
                    <td>
