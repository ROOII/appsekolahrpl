...
if($kelas != "" && $bulan != "" && $kelas != ""){
    ...
    $sql = mysqli_query($conn, "select a.nama_siswa, b.namakelas from tbsiswa a, tbkelas b, tbsetkelas c where a.id=c.idsiswa AND b.idkelas=c.idkelas AND b.idkelas=$kelas order by a.nama_siswa ASC");
